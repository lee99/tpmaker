<?php
class ContacttypeAction extends TpmakerAction {
    ...
    if(!empty($_REQUEST['searchkey'])){
        ...
        $condition['title_cn,title_en,id']=array($ser_c,$ser_c,id,$searchtype);//模糊搜索关键字全局过滤   	
    }
