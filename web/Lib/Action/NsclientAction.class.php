<?php
class NsclientAction extends TpmakerAction {
	...
	public function Index(){
		...
		$feilds='id,title_cn,callingid,logo,isvip,id';
    ...
    if(!empty($_REQUEST['searchkey'])){
        ...
        $condition['id,title_cn,info_cn,title_en,info_en,logo,isvip,id']=array($ser_c,$ser_c,$ser_c,$ser_c,$ser_c,$ser_c,$ser_c,id,$searchtype);//模糊搜索关键字全局过滤   	
    }
