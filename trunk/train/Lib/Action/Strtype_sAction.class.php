<?php
class Strtype_sAction extends PublicAction {
    ...
    if(!empty($_REQUEST['searchkey'])){
        ...
        $condition['title,pid,id,seq_no,id']=array($ser_c,$ser_c,$ser_c,$ser_c,id,$searchtype);//模糊搜索关键字全局过滤   	
    }
