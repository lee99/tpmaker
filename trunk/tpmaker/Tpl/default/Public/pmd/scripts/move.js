...
function Save2()
{
    ...
    poststr += Get_url_pos();
    makeRequest(URL+'/save_pos', poststr);
}
...
function Click_field(T, f, PK) // table field
{
    ...
    if (ON_display_field) {
        ...
        makeRequest(URL+'/display_field', 'T=' + T + '&F=' + f + '&server=' + server + '&db=' + db + '&token=' + token);
    }
}
...
function New_relation()
{
    ...
    //alert(link_relation);
    makeRequest(URL+'/relation_new', link_relation);
}
...
function Small_tab_all(id_this) // max/min all tables
{
    if (id_this.alt == "v") {
        ...
        id_this.alt = ">";
        id_this.src = pubimg+"/pmd/images/rightarrow1.png";
    } else {
        for (key in j_tabs) {
            if (document.getElementById('id_hide_tbody_'+key).innerHTML != "v") {
                Small_tab(key, 0);
        ...
        id_this.alt = "v";
        id_this.src = pubimg+"/pmd/images/downarrow1.png";
    }
    Re_load();
}
...
function Upd_relation()
{
    ...
    link_relation += '&server=' + server + '&db=' + db + '&token=' + token + '&die_save_pos=0';
    link_relation += Get_url_pos();
    makeRequest(URL+'/relation_upd', link_relation);
}
...
function No_have_constr(id_this)
{
    ...
    if (id_this.alt == 'v') {
        id_this.alt = '>';
        id_this.src = pubimg+"/pmd/images/rightarrow2.png";
    } else {
        id_this.alt = 'v';
        id_this.src = pubimg+"/pmd/images/downarrow2.png";
    }
    var E = document.form1;
    for (i = 0; i < E.elements.length; i++) {
        if (E.elements[i].type == "checkbox" && E.elements[i].id.substring(0, 10) == 'check_vis_')
...
function Show_left_menu(id_this) // max/min all tables
{
    if (id_this.alt == "v") {
        ...
        id_this.alt = ">";
        id_this.src = pubimg+"/pmd/images/uparrow2_m.png";
        if (isIE) {
            General_scroll();
        }
    } else {
        ...
        id_this.alt = "v";
        id_this.src = pubimg+"/pmd/images/downarrow2_m.png";
    }
}
//------------------------------------------------------------------------------
function Top_menu_right(id_this)
{
    if (id_this.alt == ">") {
        ...
        id_this.alt = "<";
        id_this.src = pubimg+"/pmd/images/2leftarrow_m.png";
    } else {
        document.getElementById('top_menu').style.marginLeft = 0;
        id_this.alt = ">";
        id_this.src = pubimg+"/pmd/images/2rightarrow_m.png";
    }
}
//------------------------------------------------------------------------------
