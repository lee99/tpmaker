...
CREATE TABLE IF NOT EXISTS `tp_sys_fields` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='定义每个点' AUTO_INCREMENT=1884 ;
...
(1877, 393, 'pic', '图案', 1, 1, NULL, 1, 1, '', '', 1, 1, NULL, NULL, 1, 1, '', 0, 1, '', 1, 'id', '', '', 1, 1, 1, 10, 0),
...
(1875, 393, 'strD', 'D答案', 1, 1, NULL, 1, 1, '', '', 1, 1, NULL, NULL, 1, 1, '', 0, 1, '', 1, 'id', '', '', 1, 1, 1, 8, 0),
(1873, 393, 'strB', 'B答案', 1, 1, NULL, 1, 1, '', '', 1, 1, NULL, NULL, 1, 1, '', 0, 1, '', 1, 'id', '', '', 1, 1, 1, 6, 0),
(1874, 393, 'strC', 'C答案', 1, 1, NULL, 1, 1, '', '', 1, 1, NULL, NULL, 1, 1, '', 0, 1, '', 1, 'id', '', '', 1, 1, 1, 7, 0),
(1872, 393, 'strA', 'A答案', 1, 1, NULL, 1, 1, '', '', 1, 1, NULL, NULL, 1, 1, '', 0, 1, '', 1, 'id', '', '', 1, 1, 1, 5, 0),
(1871, 393, 'strQuestion', '问题内容', 1, 4, NULL, 1, 1, '', '', 1, 1, NULL, NULL, 1, 1, '', 0, 1, '', 1, 'id', '', '', 1, 1, 1, 4, 0),
(1870, 393, 'strType_x', '试题类型', 1, 1, NULL, 1, 1, '', '', 1, 1, NULL, NULL, 1, 1, '', 0, 1, '', 1, 'id', '', '', 1, 1, 1, 9, 0),
(1869, 393, 'strType_s', '章节小类', 1, 1, NULL, 1, 1, '', '', 1, 1, NULL, NULL, 1, 1, '', 0, 1, '', 1, 'id', '', '', 1, 1, 1, 3, 0),
(1866, 394, 'id', 'ID', 1, 6, NULL, 0, 1, '', '', 1, 16, 16, NULL, 1, 0, '', 0, 2, '', 0, '', '', '', 1, 1, 1, 0, 0),
...
(1863, 394, 'seqNo', '排序', 0, 2, NULL, 0, 3, '', '', 1, 1, 1, NULL, 1, 0, '', 0, 2, '', 0, '', '', '', 1, 1, 0, 102, 0);
...
(37, 'traindb', '汽车培训', 'train', 'root', 'lee99', '123456', 0, NULL, NULL, '../ThinkPHP', 1);
...
CREATE TABLE IF NOT EXISTS `tp_sys_tables` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='数据表' AUTO_INCREMENT=397 ;
...
(395, 37, '章节大类', 'strType_f', 1, NULL, NULL, 0, NULL, 1, 1, 1, 1, 1, 1, 1, 0),
(396, 37, '章节小类', 'strType_s', 1, NULL, NULL, 0, NULL, 1, 1, 1, 1, 1, 1, 1, 0);
