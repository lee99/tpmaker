<?php
class ProjectsAction extends TpmakerAction {
	...
	public function Index(){
		...
		$feilds='title,callingId,outnewstypeId,langId,startdate,enddate,id';
    ...
    if(!empty($_REQUEST['searchkey'])){
        ...
        $condition['title,content,id']=array($ser_c,$ser_c,id,$searchtype);//模糊搜索关键字全局过滤   	
    }
	...
	public function Edit(){
		...
		$this->assign("outnewstypeId",$list["outnewstypeId"]);
		$this->assign("langId",$list["langId"]);
		$this->assign("startdate",$list["startdate"]);
		$this->assign("enddate",$list["enddate"]);
