<?php
class OutfileAction extends TpmakerAction {
	...
	public function Index(){
		...
		$feilds='id,title,content,callingId,outfiletypeId,langId,id';
    ...
    if(!empty($_REQUEST['searchkey'])){
        ...
        $condition['id,title,content,id']=array($ser_c,$ser_c,$ser_c,id,$searchtype);//模糊搜索关键字全局过滤   	
    }
	...
	public function Edit(){
		...
		$this->assign("outfiletypeId",$list["outfiletypeId"]);
		$this->assign("langId",$list["langId"]);
		$this->assign("files",$list["files"]);
