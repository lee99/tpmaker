<?php
class NsjobAction extends TpmakerAction {
	...
	public function Index(){
		...
		$feilds='id,jobno,title,endday,startday,id';
    ...
    if(!empty($_REQUEST['searchkey'])){
        ...
        $condition['id,jobno,title,content,endday,startday,id']=array($ser_c,$ser_c,$ser_c,$ser_c,$ser_c,$ser_c,id,$searchtype);//模糊搜索关键字全局过滤   	
    }
	...
	public function Edit(){
		...
		$this->assign("jobno",$list["jobno"]);
		$this->assign("title",$list["title"]);
		$this->assign("content",$list["content"]);
		$this->assign("count",$list["count"]);
		$this->assign("endday",$list["endday"]);
		$this->assign("startday",$list["startday"]);
