<?php
class Sta_infosAction extends TpmakerAction {
	...
	public function Index(){
		...
		$feilds='id,title_cn,title_en,sta_infos_typeId,langId,id';
    ...
    if(!empty($_REQUEST['searchkey'])){
        ...
        $condition['id,title_cn,title_en,content_cn,content_en,id']=array($ser_c,$ser_c,$ser_c,$ser_c,$ser_c,id,$searchtype);//模糊搜索关键字全局过滤   	
    }
	...
	public function Edit(){
		...
		$this->assign("content_cn",$list["content_cn"]);
		$this->assign("content_en",$list["content_en"]);
		$this->assign("sta_infos_typeId",$list["sta_infos_typeId"]);
