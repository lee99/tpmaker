class com.amcharts.radar.MinMax
{
    function MinMax()
    {
    } // End of the function
    static function calculate(min_defined, max_defined, data, grid_count, config)
    {
        if (config.type == "line")
        {
            var _loc2 = com.amcharts.radar.MinMax.getMax(data, -Number.MAX_VALUE, "value");
            _loc2 = com.amcharts.radar.MinMax.getMax(data, _loc2, "start", config);
        } // end if
        if (config.type == "stacked")
        {
            _loc2 = com.amcharts.radar.MinMax.getSumMax(data, -Number.MAX_VALUE, "value", config);
            _loc2 = com.amcharts.radar.MinMax.getMax(data, _loc2, "value", config);
        } // end if
        if (config.type == "100% stacked")
        {
            _loc2 = com.amcharts.radar.MinMax.getSumMax(data, -Number.MAX_VALUE, "percent", config);
            _loc2 = com.amcharts.radar.MinMax.getMax(data, _loc2, "percent", config);
        } // end if
        if (isNaN(max_defined) == false && (max_defined >= _loc2 || config.values.strict_min_max == true))
        {
            _loc2 = max_defined;
        }
        else
        ...
        if (config.type == "line")
        {
            var _loc1 = com.amcharts.radar.MinMax.getMin(data, Number.MAX_VALUE, "value");
            _loc1 = com.amcharts.radar.MinMax.getMin(data, _loc1, "start", config);
        } // end if
        if (config.type == "stacked")
        {
            _loc1 = com.amcharts.radar.MinMax.getSumMin(data, Number.MAX_VALUE, "value", config);
            _loc1 = com.amcharts.radar.MinMax.getMin(data, _loc1, "value", config);
        } // end if
        if (config.type == "100% stacked")
        {
            _loc1 = com.amcharts.radar.MinMax.getSumMin(data, Number.MAX_VALUE, "percent", config);
            _loc1 = com.amcharts.radar.MinMax.getMin(data, _loc1, "percent", config);
        } // end if
        var _loc4 = _loc1;
        if (isNaN(min_defined) == false && (min_defined <= _loc1 || config.values.strict_min_max == true))
        {
            _loc1 = min_defined;
        }
        else
