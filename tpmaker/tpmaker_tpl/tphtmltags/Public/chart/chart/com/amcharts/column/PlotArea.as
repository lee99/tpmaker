class com.amcharts.column.PlotArea
{
    ...
    function __init()
    {
        var _loc4 = new com.amcharts.Rectangle(__mc, "rectangle_mc", 0, __width, __height, __color, 0, __border_color, 0, __alpha, __border_alpha);
        if (__dx > 0 || __dy > 0)
        {
            _loc4.mc._x = __dx;
            _loc4.mc._y = __dy;
            ...
            var _loc3 = new com.amcharts.Shape(__mc, "xShape_mc", 1, [0, __dx, __width + __dx, __width, 0], [0, __dy, __dy, 0, 0], _loc2, 0, 0, __alpha, 0);
            _loc3.mc._y = __height;
            new com.amcharts.Brightness(_loc3.mc, -15);
