...
CREATE TABLE IF NOT EXISTS `tp_designer` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='数据关联' AUTO_INCREMENT=10 ;
...
CREATE TABLE IF NOT EXISTS `tp_designer_coords` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='坐标定位' AUTO_INCREMENT=415 ;
...
(414, 26, 'sta_infos_type', 646, 320, 0, 1),
(413, 26, 'sta_infos', 44, 264, 0, 1),
(412, 26, 'contacttype', 15, 139, 0, 1),
(411, 26, 'tree', 1004, 71, 0, 1),
(410, 26, 'dept', 976, 357, 0, 1),
(409, 26, 'nsclient', 668, 274, 0, 1),
(408, 26, 'nsjob', 481, 68, 0, 1),
(407, 26, 'contact', 892, 86, 0, 1),
(406, 26, 'calling', 982, 426, 0, 1),
(405, 26, 'group', 626, 120, 0, 1),
(404, 26, 'node', 307, 269, 0, 1),
(403, 26, 'groupuser', 590, 244, 0, 1),
(402, 26, 'attach', 91, 380, 0, 1),
(401, 26, 'access', 327, 149, 0, 1),
(400, 26, 'user', 902, 111, 0, 1),
(399, 26, 'hotjob', 205, 179, 0, 1),
(398, 26, 'lang', 789, 376, 0, 1),
(397, 26, 'outfiletype', 47, 341, 0, 1),
(396, 26, 'outfile', 641, 421, 0, 1),
(395, 26, 'outnewstype', 255, 50, 0, 1),
(394, 26, 'outnews', 1013, 493, 0, 1),
(393, 26, 'flashad', 488, 363, 0, 1),
(392, 26, 'projects', 346, 138, 0, 1);
...
(1, 1, '人才管理系统', 'Person', 2, 2, 1, 0, 385, 1, 1, 1, 1, 1, 1, 1),
(2, 1, '企业管理系统', 'Company', 2, 1, 2, 0, 385, 1, 1, 1, 1, 1, 1, 1),
(3, 1, '订单管理系统', 'Order', 2, 1, 3, 0, 385, 1, 1, 1, 1, 1, 1, 1),
(4, 1, '职位管理系统', 'Jobs', 2, 1, 4, 0, 385, 1, 1, 1, 1, 1, 1, 1),
(5, 1, '面试管理系统', 'Interview', 1, 2, 5, 0, 385, 1, 1, 1, 1, 1, 1, 1),
(6, 1, '推荐管理系统', 'Recomand', 1, 2, 6, 0, 385, 1, 1, 1, 1, 1, 1, 1),
(7, 1, '人才语言', 'Lang', 1, 2, 7, 0, 385, 1, 1, 1, 1, 1, 1, 1),
(8, 1, '地区管理', 'Area', 1, 2, 8, 0, 385, 1, 1, 1, 1, 1, 1, 1),
(10, 1, '人才到岗时间', 'Left_time', 1, 2, 10, 0, 385, 1, 1, 1, 1, 1, 1, 1),
(11, 1, '企业福利', 'Bas_boon', 1, 2, 11, 0, 385, 1, 1, 1, 1, 1, 1, 1),
(12, 1, '行业汇总表', 'Bas_calling', 2, 2, 12, 0, 385, 1, 1, 1, 1, 1, 1, 1),
(13, 1, '[公共]招聘途径', 'Bas_path', 2, 2, 13, 0, 385, 1, 1, 1, 1, 1, 1, 1),
(14, 1, '企业年薪类型', 'Bas_payinfo', 2, 2, 14, 0, 385, 1, 1, 1, 1, 1, 1, 1),
(15, 1, '职位分类表', 'Bas_post', 2, 2, 15, 0, 385, 1, 1, 1, 1, 1, 1, 1),
(16, 1, '企业电话类型', 'Bas_souretype', 2, 2, 16, 0, 385, 1, 1, 1, 1, 1, 1, 1),
(17, 1, '客户之间的关系', 'Com2com', 2, 2, 17, 0, 385, 1, 1, 1, 1, 1, 1, 1),
(18, 1, '简单系统保留', 'Sim_system', 2, 2, 18, 1, 385, 1, 1, 1, 1, 1, 1, 1),
(19, 8, '小说作品管理', 'Xiaoshuoshow', 1, 1, 0, 0, 385, 1, 1, 1, 1, 1, 1, 1),
(20, 8, '从文札记管理', 'Zhaji', 1, 1, 1, 0, 385, 1, 1, 1, 1, 1, 1, 1),
(21, 8, '客家文化研究', 'Kejianwenhu', 1, 1, 2, 0, 385, 1, 1, 1, 1, 1, 1, 1),
(22, 8, '关于本人', 'Aboutme', 1, 1, 3, 0, 385, 1, 1, 1, 1, 1, 1, 1),
(23, 8, '个人荣誉', 'Rongyu', 1, 1, 4, 0, 385, 1, 1, 1, 1, 1, 1, 1),
(24, 8, '公共属性', 'Pu_class', 1, 1, 100, 1, 385, 1, 1, 1, 1, 1, 1, 1),
(25, 8, '小说章节管理', 'Xiaoshuo', 1, 1, 0, 0, 385, 1, 1, 1, 1, 1, 1, 1),
(26, 8, '从文札记分类', 'Zhajitype', 1, 1, 1, 0, 385, 1, 1, 1, 1, 1, 1, 1),
(124, 20, 'NSweb公共', 'WEBpub', 1, 1, 0, 1, 124, 1, 1, 1, 1, 1, 1, 1),
(44, 41, '从文札记管理', 'Array', 1, 1, 1, 0, 385, 1, 1, 1, 1, 1, 1, 1),
(43, 41, '从文札记管理', 'Array', 1, 1, 1, 0, 385, 1, 1, 1, 1, 1, 1, 1),
(42, 39, '小说章节管理', 'Array', 1, 1, 0, 0, 385, 1, 1, 1, 1, 1, 1, 1),
(41, 39, '小说章节管理', 'Array', 1, 1, 0, 0, 385, 1, 1, 1, 1, 1, 1, 1),
(125, 20, '网站静态信息', 'sta_infos', 1, 1, 1, 0, 124, 1, 1, 1, 1, 1, 1, 1),
(126, 20, '网站静态信息分类', 'sta_infos_type', 1, 1, 1, 0, 124, 1, 1, 1, 1, 1, 1, 1),
(45, 43, '从文札记分类', 'Array', 1, 1, 1, 0, 385, 1, 1, 1, 1, 1, 1, 1),
(46, 43, '从文札记分类', 'Array', 1, 1, 1, 0, 385, 1, 1, 1, 1, 1, 1, 1),
(47, 45, '客家文化研究', 'Array', 1, 1, 2, 0, 385, 1, 1, 1, 1, 1, 1, 1),
(48, 45, '客家文化研究', 'Array', 1, 1, 2, 0, 385, 1, 1, 1, 1, 1, 1, 1),
(49, 47, '关于本人', 'Array', 1, 1, 3, 0, 385, 1, 1, 1, 1, 1, 1, 1),
(50, 47, '关于本人', 'Array', 1, 1, 3, 0, 385, 1, 1, 1, 1, 1, 1, 1),
(51, 49, '个人荣誉', 'Array', 1, 1, 4, 0, 385, 1, 1, 1, 1, 1, 1, 1),
(52, 49, '个人荣誉', 'Array', 1, 1, 4, 0, 385, 1, 1, 1, 1, 1, 1, 1),
(53, 51, '公共属性', 'Array', 1, 1, 100, 1, 385, 1, 1, 1, 1, 1, 1, 1),
(54, 51, '公共属性', 'Array', 1, 1, 100, 1, 385, 1, 1, 1, 1, 1, 1, 1),
(139, 20, '留言类型分类', 'contacttype', 1, 1, 10, 0, 385, 1, 1, 1, 1, 1, 1, 1),
...
(136, 20, '网上留言管理', 'contact', 1, 1, 10, 0, 385, 1, 1, 1, 1, 1, 1, 1),
...
(142, 21, '[公用]', 'tmp_sql', 1, 1, 5, 1, 385, 1, 1, 1, 1, 1, 1, 1),
(143, 21, '单元管理', 'items', 1, 1, 6, 0, 385, 1, 1, 1, 1, 1, 1, 1),
(144, 21, '单元类别管理', 'items_type', 1, 1, 7, 0, 385, 1, 1, 1, 1, 1, 1, 1),
(145, 21, '订单管理', 'order', 1, 1, 8, 0, 385, 1, 1, 1, 1, 1, 1, 1),
(146, 21, '订单状态日志', 'orderlogs', 1, 1, 9, 0, 385, 1, 1, 1, 1, 1, 1, 1),
(147, 21, '用户管理', 'user', 1, 1, 10, 0, 385, 1, 1, 1, 1, 1, 1, 1),
(148, 21, '系统权限表', 'access', 1, 1, 11, 0, 385, 1, 1, 1, 1, 1, 1, 1),
(149, 21, '权限组别用户', 'groupuser', 1, 1, 12, 0, 385, 1, 1, 1, 1, 1, 1, 1),
(150, 21, '权限组别', 'group', 1, 1, 13, 0, 385, 1, 1, 1, 1, 1, 1, 1),
(151, 21, '权限节点', 'node', 1, 1, 14, 0, 385, 1, 1, 1, 1, 1, 1, 1),
(152, 21, '系统设定', 'sysconfig', 1, 1, 15, 0, 385, 1, 1, 1, 1, 1, 1, 1),
(153, 21, '供应商&客户管理', 'company', 1, 1, 1, 0, 385, 1, 1, 1, 1, 1, 1, 1),
(154, 21, '联络人员管理', 'contactlist', 1, 1, 2, 0, 385, 1, 1, 1, 1, 1, 1, 1),
(155, 21, '公司备注', 'comnotes', 1, 1, 3, 0, 385, 1, 1, 1, 1, 1, 1, 1),
(156, 21, '公司地址', 'comaddrs', 1, 1, 4, 0, 385, 1, 1, 1, 1, 1, 1, 1),
...
(161, 20, '对外信息管理', 'outnews', 1, 1, 7, 0, 385, 1, 1, 1, 1, 1, 1, 1),
(162, 20, 'FLASH广告管理', 'flashad', 1, 1, 6, 0, 124, 1, 1, 1, 1, 1, 1, 1),
(163, 20, '成功案例管理', 'projects', 1, 1, 7, 0, 385, 1, 1, 1, 1, 1, 1, 1),
(284, 26, '成功案例管理', 'projects', 1, 1, 7, 0, 261, 1, 1, 1, 1, 1, 1, 1),
(283, 26, 'FLASH广告管理', 'flashad', 1, 1, 6, 0, 261, 1, 1, 1, 1, 1, 1, 1),
(282, 26, '对外信息管理', 'outnews', 1, 1, 7, 0, 385, 1, 1, 1, 1, 1, 1, 1),
(281, 26, '对外信息分类', 'outnewstype', 1, 1, 7, 0, 385, 1, 1, 1, 1, 1, 1, 1),
(280, 26, '对外资料管理', 'outfile', 1, 1, 6, 0, 261, 1, 1, 1, 1, 1, 1, 1),
(279, 26, '对外资料分类', 'outfiletype', 1, 1, 6, 0, 261, 1, 1, 1, 1, 1, 1, 1),
(277, 26, '发布语言分类', 'lang', 1, 1, 0, 0, 261, 1, 1, 1, 1, 1, 1, 1),
(278, 26, '热门职位', 'hotjob', 1, 1, 5, 0, 261, 1, 1, 1, 1, 1, 1, 1),
(276, 26, '用户管理', 'user', 1, 1, 0, 0, 261, 1, 1, 1, 1, 1, 1, 0),
(274, 26, '系统权限表', 'access', 1, 1, 0, 0, 261, 1, 1, 1, 1, 1, 1, 0),
(275, 26, '附件管理', 'attach', 1, 1, 0, 0, 261, 1, 1, 1, 1, 1, 1, 0),
(273, 26, '权限组别用户', 'groupuser', 1, 1, 0, 0, 261, 1, 1, 1, 1, 1, 1, 0),
(271, 26, '权限节点', 'node', 1, 1, 0, 0, 261, 1, 1, 1, 1, 1, 1, 0),
(272, 26, '权限组别', 'group', 1, 1, 0, 0, 261, 1, 1, 1, 1, 1, 1, 0),
(270, 26, '行业分类', 'calling', 1, 1, 0, 0, 261, 1, 1, 1, 1, 1, 1, 1),
(269, 26, '网上留言管理', 'contact', 1, 1, 10, 0, 385, 1, 1, 1, 1, 1, 1, 1),
(268, 26, 'Ns公司招聘', 'nsjob', 1, 1, 5, 0, 261, 1, 1, 1, 1, 1, 1, 1),
(267, 26, '客户列表', 'nsclient', 1, 1, 0, 0, 261, 1, 1, 1, 1, 1, 1, 1),
(266, 26, '公司部门管理', 'dept', 1, 1, 0, 0, 261, 1, 1, 1, 1, 1, 1, 0),
(265, 26, '树状菜单', 'tree', 1, 1, 0, 0, 261, 1, 1, 1, 1, 1, 1, 0),
(264, 26, '留言类型分类', 'contacttype', 1, 1, 10, 0, 385, 1, 1, 1, 1, 1, 1, 1),
(261, 26, 'NSweb公共', 'WEBpub', 1, 1, 0, 1, 261, 1, 1, 1, 1, 1, 1, 1),
(262, 26, '网站静态信息', 'sta_infos', 1, 1, 1, 0, 261, 1, 1, 1, 1, 1, 1, 1),
(263, 26, '网站静态信息分类', 'sta_infos_type', 1, 1, 1, 0, 261, 1, 1, 1, 1, 1, 1, 1);
